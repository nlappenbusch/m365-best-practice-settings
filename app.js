...
const config = {
    ...
    antiSpam: {
        bulkThreshold: 7,
        // Legacy-ASF-Optionen: Microsoft-Empfehlung ist Off (auch in Microsofts
        // Standard-/Strict-Presets) — sie uebersteuern ARC/Composite-Auth,
        // erzeugen False Positives (z.B. SPF-Hartfehler hinter Inline-Gateways
        // wie SEPPmail) und sind nicht als False Positive meldbar.
        bizInfoUrls: false,
        numericIpUrls: false,
        urlRedirect: false,
        emptyMessages: false,
